...
void rgb_led_set_color (const rgb_color_t * color) {
    *color_red_value = (uint16_t)(((float)color->red) / RGB_MAX_VALUE * PWM_MAX_VALUE);
    *color_green_value = (uint16_t)(((float)color->green) / RGB_MAX_VALUE * PWM_MAX_VALUE);
    *color_blue_value = (uint16_t)(((float)color->blue) / RGB_MAX_VALUE * PWM_MAX_VALUE);
}
